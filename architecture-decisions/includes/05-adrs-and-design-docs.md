...
> **Related:** Overview process → [00-overview.md](00-overview.md) · ARB(Architecture Review Board) / decision rights → [§5A](05A-architecture-governance.md) · Tradeoffs → [06-tradeoff-frameworks.md](06-tradeoff-frameworks.md) · Tech lead culture → [tech-lead-practice](../../tech-lead-practice/README.md)
