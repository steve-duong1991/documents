...
> **Related:** LSM state stores → [tree §4 LSM](../../tree-and-index-structures/includes/04-lsm-trees.md) · CDC → [§8 integration](08-integration-patterns.md) · Mirror/DR → [§10 DR](10-operations-dr-security-and-observability.md)
...
| **ksqlDB / Flink** | SQL or large-scale stream processing (external) |
...
| **Dead letter queue** | Route failed records to DLQ topic |
...
MM2 is **async** — RPO > 0; not a synchronous dual-write.
...
| **REST Proxy** | HTTP produce/consume (limited; not primary API) |
