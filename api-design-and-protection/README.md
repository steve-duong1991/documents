...
| 1A | [HTTP caching and conditional requests](includes/01A-http-caching-and-conditional-requests.md) |
| 2 | [API protection](includes/02-api-protection.md) |
| 2A | [Edge abuse, WAF, and bots](includes/02A-edge-abuse-waf-and-bots.md) |
...
| 5A | [Metering, entitlements, and billable events](includes/05A-metering-entitlements-and-billable-events.md) |
...
| 7B | [Partner sandbox and API keys](includes/07B-partner-sandbox-and-api-keys.md) |
...
| **Partner / public API portal** | [§7 OpenAPI](includes/07-openapi-swagger.md) → [§7A developer portal](includes/07A-developer-portal.md) → [§7B partner sandbox](includes/07B-partner-sandbox-and-api-keys.md) → [§5 tiers](includes/05-rate-limit-tiers.md) → [§3 gateway](includes/03-api-gateway.md) |
| **Metering and billable usage** | [§5A metering](includes/05A-metering-entitlements-and-billable-events.md) → [§5 tiers](includes/05-rate-limit-tiers.md) → [finops §1](../finops-and-cost/includes/01-unit-economics.md) |
| **Edge abuse / WAF(Web Application Firewall) / bots** | [§2A edge abuse](includes/02A-edge-abuse-waf-and-bots.md) → §2 → §6 → [api-rate-limiting §7](../api-rate-limiting/includes/07-deployment-layers.md) |
