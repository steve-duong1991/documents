...
> **Related:** Architecture decisions → [architecture-decisions](../../architecture-decisions/README.md) · Product discovery → [§1A](01A-product-discovery.md) · Debt × business × CX(Customer Experience) → [§5A](05A-debt-business-cx-balance.md) · Reliability practice → [sre-and-incidents](../../sre-and-incidents/README.md) · Decision picker → [§11](11-decision-guide.md)
